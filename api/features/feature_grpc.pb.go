...
type FeatureClient interface {
	AddPriority(ctx context.Context, in *PriorityStruct, opts ...grpc.CallOption) (*IdStruct, error)
...
func (c *featureClient) AddPriority(ctx context.Context, in *PriorityStruct, opts ...grpc.CallOption) (*IdStruct, error) {
	out := new(IdStruct)
...
func (c *featureClient) GetFeaturesById(ctx context.Context, in *IdStruct, opts ...grpc.CallOption) (*HibrydFeature, error) {
	out := new(HibrydFeature)
	err := c.cc.Invoke(ctx, Feature_GetFeaturesById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FeatureServer interface {
	AddPriority(context.Context, *PriorityStruct) (*IdStruct, error)
...
func (UnimplementedFeatureServer) AddPriority(context.Context, *PriorityStruct) (*IdStruct, error) {
...
func _Feature_GetFeaturesById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IdStruct)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FeatureServer).GetFeaturesById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Feature_GetFeaturesById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeatureServer).GetFeaturesById(ctx, req.(*IdStruct))
	}
	return interceptor(ctx, in, info, handler)
}
